    ...
    public class ErrorReportEntry
    {
        ...
        public string GetDescriptionText()
        {
            ...
            switch (ProblemType)
            {
                ...
                case ErrorReportProblemType.ERROR_REPORT_PROBLEM_TYPE_MAT_NOT_UNIQ_MAT:
                    {

                        var stringFormat = Localizator.Get("ERROR_REPORT_PROBLEM_TYPE_MAT_NOT_UNIQ_MAT") + " {0}";

                        result = String.Format(stringFormat, vobName);
                    };
                    break;

                case ErrorReportProblemType.ERROR_REPORT_PROBLEM_TYPE_WP_NO_TOT:
                    {

                        var stringFormat = Localizator.Get("ERROR_REPORT_PROBLEM_TYPE_WP_NO_TOT") + " {0}";

                        result = String.Format(stringFormat, vobName);
                    }; 
                    break;
                case ErrorReportProblemType.ERROR_REPORT_PROBLEM_TYPE_MOBCONT_NOT_CLOSED:
                    {

                        var stringFormat = Localizator.Get("ERROR_REPORT_PROBLEM_TYPE_MOBCONT_NOT_CLOSED") + " {0}";
                ...
                case ErrorReportProblemType.ERROR_REPORT_PROBLEM_TYPE_MOBCONT_CLOSED_NO_KEY:
                    ...
                    break;
                case ErrorReportProblemType.ERROR_REPORT_PROBLEM_TYPE_SOUNDNAMEDAYTIME_NOINST:
                    {

                        var stringFormat = Localizator.Get("ERROR_REPORT_PROBLEM_TYPE_SOUNDNAMEDAYTIME_NOINST") + " {0}";
