...
namespace SpacerUnion.Common
{
    public partial class Localizator
    {
        public static void Init()
        {
            ...
            words.Add("WIN_VOBCATALOG_ADV_DONT_SEARCH", new List<string> { "Не показывать Вобы Каталога в поиске", "Don't show Catalog's vobs in search", "Keine Katalog VOBs in Suche anzeigen", "Nie pokazuj vobów z Katalogu w wyszukiwaniu", "Nezobrazovat Katalog Vobů ve vyhledávání" });
