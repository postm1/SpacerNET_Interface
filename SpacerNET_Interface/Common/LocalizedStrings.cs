...
namespace SpacerUnion.Common
{
    public partial class Localizator
    {
        public static void Init()
        {
            ...
            AddNewWord("WIN_LIGHT_PRESET_NOT_FOUND", new List<string> { "У выбранного lightvob нет сохранённого пресета. Создайте новый пресет и выберите его.", "The selected light vob has no saved preset. Create and select a new preset.", "Der ausgewählte LightVob hat kein gespeichertes Preset. Erstelle und wähle ein neues Preset aus.", "Wybrany lightvob nie ma zapisanego presetu. Utwórz i wybierz nowy preset.", "Vybraný lightvob nemá uloženou předvolbu. Vytvořte a vyberte novou předvolbu." });
