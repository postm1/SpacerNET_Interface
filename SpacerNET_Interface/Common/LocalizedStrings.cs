...
namespace SpacerUnion.Common
{
    public partial class Localizator
    {
        public static void Init()
        {
            ...
            words.Add("ERROR_REPORT_PROBLEM_TYPE_MOBCONT_NOT_CLOSED", new List<string> { "oCMobContainer имеет locked = FALSE, но комбинация взлома или инстанция ключа установлены", "oCMobContainer has locked = FALSE, but a lock combination or key instance is set", "", "", "" });
