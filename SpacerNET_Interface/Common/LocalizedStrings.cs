...
namespace SpacerUnion.Common
{
    public partial class Localizator
    {
        public static void Init()
        {
            ...
            words.Add("WIN_VOBCATALOG_HIDE_PREVIEW", new List<string> { "Скрывать 3D превью-модель при скрытии окна", "Hide 3D preview when window is hidden", "3D-Vorschau ausblenden, wenn das Fenster ausgeblendet ist", "Schowaj podgląd 3d gdy okno jest schowane", "Skrytí 3D náhledu při skrytém okně" });//fixme
            ...
            words.Add("WIN_VOBCATALOG_ADV_DONT_SEARCH", new List<string> { "Не показывать Вобы Каталога в глобальном поиске", "Don't show Catalog's vobs in global search", "Keine Katalog VOBs in Suche anzeigen", "Nie pokazuj vobsów Katalogu w wyszukiwaniu globalnym", "Nezobrazovat Katalog Vobů ve vyhledávání" });//fixme
