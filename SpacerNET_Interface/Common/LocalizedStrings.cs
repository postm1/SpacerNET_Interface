...
namespace SpacerUnion.Common
{
    public partial class Localizator
    {
        public static void Init()
        {
            ...
            words.Add("ERROR_REPORT_PROBLEM_TYPE_FOCUS_NAME", new List<string> { "Такой 'focusName' не существует в скриптах", "Such 'focusName' does not exist in scripts", "Ein solcher 'focusName' existiert nicht in den Skripten", "", "Takový 'focusName' ve skriptech neexistuje" });
            words.Add("ERROR_REPORT_PROBLEM_TYPE_KEY_INSTANCE", new List<string> { "Такой 'keyInstance' не существует в скриптах", "Such 'keyInstance' does not exist in scripts", "Eine solche 'keyInstance' existiert nicht in den Skripten", "", "Taková 'keyInstance' ve skriptech neexistuje" });
            words.Add("ERROR_REPORT_PROBLEM_TYPE_CONTAINTER_ITEM", new List<string> { "Такой oCItem из 'contains' не существует в скриптах", "Such oCItem in 'contains' does not exist", "Ein solches oCItem in 'contains' existiert nicht", "", "Takový oCItem v 'contains' neexistuje" });
            words.Add("ERROR_REPORT_PROBLEM_TYPE_SPACES_CONTAINER", new List<string> { "Поле 'contains' содержит пробелы", "Field 'contains' has spaces", "Feld 'contains' hat Leerzeichen", "", "Pole 'contains' obsahuje mezery" });
            words.Add("ERROR_REPORT_PROBLEM_TYPE_SOUNDNAME", new List<string> { "Поле 'sndName' пустое", "Field 'sndName' is empty", "Feld 'sndName' ist leer", "", "Pole 'sndName' je prázdné" });
            words.Add("ERROR_REPORT_PROBLEM_TYPE_SOUNDNAME_NOINST", new List<string> { "Прописанный sndName не существует в SFX.dat", "Such sndName does not exist in SFX.dat", "Ein solcher sndName existiert nicht in SFX.dat", "", "Takový sndName v souboru SFX.dat neexistuje" });
            words.Add("ERROR_REPORT_PROBLEM_TYPE_CONTAINER_BAD_SYMBOLS", new List<string> { "Поле 'contains' содержит неверные символы", "Field 'contains' has bad symbols", "Feld 'contains' hat falsche Symbole", "", "Pole 'contains' má špatné symboly" });
